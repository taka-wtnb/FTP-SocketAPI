...
** Program name: CS372 Project 2 ftserver (plain version)
...
**              This is a back-up version and doesn't include any extra credit feature. For details of the extra credit
**              feature and usage of this plain version, please refer to README.txt file in the submission zip file.  
